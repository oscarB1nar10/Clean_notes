...
class InsertNewNoteTest {
    ...
    fun insertNote_success_confirmNetworkAndCacheUpdated() = runBlocking {
        ...
        val networkNoteThatWasUpdated = noteNetworkDataSource.searchNote(newNote)
        assertTrue{networkNoteThatWasUpdated == newNote}
    }
    ...
    fun insertNote_fail_confirmNetworkAndCacheUnchanged() = runBlocking {
        ...
        val networkNoteThatWasUpdated = noteNetworkDataSource.searchNote(newNote)
        assertTrue{networkNoteThatWasUpdated == null}
    }
